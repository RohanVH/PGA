                    ...
                    <center>
                        ...
                        <div class="justify-content-center" style="color: black;text-align: center;">
                            ...
                            <table class="table table-dark" style="color:black;border:2px solid black;">
                                ...
                                $query = "SELECT `student name`, `email`, `semester` from lecture1";
                        ...
                        <center>
                            ...
                            <div class="justify-content-center" style="color: black;text-align: center;">
                                ...
                                <table class="table table-dark" style="color:black;border:2px solid black;">
                                    ...
                                    $query = "SELECT `student name`, `email`, `semester` from lecture3";
                                    $check = mysqli_query($connectdb, $query);
                                    while ($row = mysqli_fetch_array($check)) {
                                        $name = $row['student name'];
                                        $email = $row['email'];
                        ...
                        <center>
                            ...
                            <div class="justify-content-center" style="color: black;text-align: center;">
                                ...
                                <table class="table table-dark" style="color:black;border:2px solid black;">
                                    ...
                                    $query = "SELECT `student name`, `email`, `semester` from lecture4";
                                    $check = mysqli_query($connectdb, $query);
                                    while ($row = mysqli_fetch_array($check)) {
                                        $name = $row['student name'];
                                        $email = $row['email'];
                        ...
                        <center>
                            ...
                            <div class="justify-content-center" style="color: black;text-align: center;">
                                ...
                                <table class="table table-dark" style="color:black;border:2px solid black;">
                                    ...
                                    $query = "SELECT `student name`, `email`, `semester` from lecture5";
                                    $check = mysqli_query($connectdb, $query);
                                    while ($row = mysqli_fetch_array($check)) {
                                        $name = $row['student name'];
                                        $email = $row['email'];
                        ...
                        <center>
                            ...
                            <div class="justify-content-center" style="color: black;text-align: center;">
                                ...
                                <table class="table table-dark" style="color:black;border:2px solid black;">
                                    ...
                                    $query = "SELECT `student name`, `email`, `semester` from lecture6";
                                    $check = mysqli_query($connectdb, $query);
                                    while ($row = mysqli_fetch_array($check)) {
                                        $name = $row['student name'];
                                        $email = $row['email'];
