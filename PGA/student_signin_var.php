		...
		<div class="row align-items-start">
			<div class="col">
				<div class="container-fluid" style="background-color: #b3b3b3;">
					...
					<center>
						<u class="h3">
							<b id="hover-underline-animation">
								<?php
								include 'student_signin.php';
								session_start();
								$emails = $_SESSION['emails'];
								$fetchtable = "SELECT 'lecture1' email from lecture1 where email='$emails' UNION ALL" . " SELECT 'lecture2' email from lecture2 where email='$emails' UNION ALL SELECT 'lecture3' email from lecture3 where email='$emails' UNION ALL SELECT 'lecture4' email from lecture4 where email='$emails' UNION ALL SELECT 'lecture5' email from lecture5 where email='$emails' UNION ALL SELECT 'lecture6' email from lecture6 where email='$emails'";
								$ft = mysqli_query($connectdb, $fetchtable);
								while ($mail = mysqli_fetch_assoc($ft)) {
									$mail = implode(",", $mail);
									...
									if ($mail == 'lecture1') {
										echo $lecuture1;
									} elseif ($mail == 'lecture2') {
										echo $lecuture2;
									} elseif ($mail == 'lecture3') {
										echo $lecuture3;
									} elseif ($mail == 'lecture4') {
										echo $lecuture4;
									} elseif ($mail == 'lecture5') {
										echo $lecuture5;
									} elseif ($mail == 'lecture6') {
										echo $lecuture6;
									}
								}
								?>
						...
						<div class="justify-content-center" style="color: black;text-align: center;">
							...
							<table class="table table-dark" style="color:black;border:2px solid black;">
								...
								while ($mail = mysqli_fetch_assoc($ft)) {
									$mail = implode(",", $mail);
									$query = "SELECT `student name`, `email`, `semester` from $mail";
